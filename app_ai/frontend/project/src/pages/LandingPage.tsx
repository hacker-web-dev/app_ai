      ...
      <section className="py-20 mt-10" id="features">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">How PriceAI Works</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100 transition-all duration-200 hover:shadow-md">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Search Services</h3>
          ...
          <div className="mt-20" id="how-it-works">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Find Healthcare Savings in 3 Steps</h2>
              <p className="text-lg text-gray-600">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="relative">
                ...
                <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100 transition-all duration-200 hover:shadow-md h-full">
                  <h3 className="text-xl font-bold text-gray-900 mb-4 pt-4">Enter Your Location</h3>
              ...
              <div className="relative">
                ...
                <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100 transition-all duration-200 hover:shadow-md h-full">
                  <h3 className="text-xl font-bold text-gray-900 mb-4 pt-4">Select a Service</h3>
                  <p className="text-gray-600 mb-4">
              ...
              <div className="relative">
                ...
                <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100 transition-all duration-200 hover:shadow-md h-full">
                  <h3 className="text-xl font-bold text-gray-900 mb-4 pt-4">Compare & Save</h3>
                  <p className="text-gray-600 mb-4">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                <h3 className="text-lg font-bold text-gray-900 mb-2">How accurate are the prices on PriceAI?</h3>
                <p className="text-gray-600">
              ...
              {/* FAQ Item 2 */}
              <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                <h3 className="text-lg font-bold text-gray-900 mb-2">Does PriceAI work with all insurance plans?</h3>
                <p className="text-gray-600">
              ...
              {/* FAQ Item 3 */}
              <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                <h3 className="text-lg font-bold text-gray-900 mb-2">How do I know which provider is best for me?</h3>
                <p className="text-gray-600">
              ...
              {/* FAQ Item 4 */}
              <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                <h3 className="text-lg font-bold text-gray-900 mb-2">Is PriceAI free to use?</h3>
                <p className="text-gray-600">
      ...
      <section className="py-20 bg-gradient-to-br from-indigo-600 to-indigo-800 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button 
              onClick={() => navigate('/search')}
              className="px-8 py-4 bg-white text-indigo-600 font-bold rounded-lg hover:bg-gray-100 transition-colors flex items-center justify-center"
            >
              <Search className="mr-2 h-5 w-5" />
              Compare Prices Now
            </button>
